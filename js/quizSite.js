...
(function() {
    ...
    function showResults() {
        ...
        quizContainer.querySelectorAll(".answers"); // This will basically give us back an array containing everything in the quizContainer with the class "answers"
        
        // Variable to keep track of hor many they get right
        var numCorrect = 0;
        ...
        for (var i = 0; i < answerContainers.length; i++) 
        {
            ...
            var userAnswer = (answerContainer.querySelector(selector) || {}).value; // If it can't find a selected input for a question, querySelector will give bak null. If it does, use an empty object instead, since {.value gives back undefined instead of null}
            ...
            if (userAnswer === myQuestions[i].correctAnswer) {
                ...
                // They got it wrong!
                // Change the text color of the elements in the answer container to red
